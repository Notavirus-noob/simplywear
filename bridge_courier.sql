...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 24, 2025 at 02:01 AM
...
CREATE TABLE `orders` (
  ...
  `modified at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `orders` (`order_id`, `user_id`, `total_price`, `status`, `created_at`, `modified_by`, `modified at`) VALUES
(19, 14, 2400.00, 'approved', '2025-02-23 21:27:43', NULL, NULL),
(20, 14, 4000.00, 'pending', '2025-02-23 21:28:08', NULL, NULL),
...
INSERT INTO `realcart` (`cart_id`, `user_id`, `prod_id`, `product_name`, `price`, `size`, `quantity`, `added_at`, `image`) VALUES
(17, 14, 20, 'Hawaii Tshirt', 2000.00, 'M', 1, '2025-02-23 21:47:07', 'f1.jpg');
